...
. ^5^ ##Supported on Cloud Volumes ONTAP 9.18.1 and later, the c3-standard-44 and c3-standard-88 variants of these VMs support Tier-1 bandwidth in Google Cloud Console by default.##
--
