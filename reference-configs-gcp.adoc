...
. ^5^ ##Supported on Cloud Volumes ONTAP 9.18.1 and later, the c3-standard-44 and c3-standard-88 variants of these VMs support Tier-1 bandwidth in Google Cloud Console by default. Currently, you can't configure an additional disk to your aggregate when using a C3 VM type, neither can you change the VM type to another variant within the C3 family. Refer to Flash Cache support.##
--
...
|===
| VM type                | Maximum number of LSSDs supported
...
|===
| VM type                | Maximum supported disks  | Maximum capacity (in TiB)

| All n2 instances       | 128                      | 257
| c3-standard-4          | 4 + 12                   | 256
| c3-standard-8          | 4 + 12                   | 256
| c3-standard-22         | 4 + 28                   | 256
| c3-standard-44         | 4 + 28                   | 512
| c3-standard-88         | 4 + 28                   | 512
| c3-standard-4-lssd     | 4 + 12                   | 256
| c3-standard-8-lssd     | 4 + 12                   | 256
| c3-standard-22-lssd    | 4 + 28                   | 256
| c3-standard-44-lssd    | 4 + 28                   | 512
| c3-standard-88-lssd    | 4 + 28                   | 512
|===
