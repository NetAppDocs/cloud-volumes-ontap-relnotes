...
+
If you choose any of these VM types when you deploy a new Cloud Volumes ONTAP system, you can't change to another VM type that _doesn't_ use an Ultra SSD for VNVRAM. For example, you can't change from E8ds_v4 to E8s_v3, but you can change from E8ds_v4 to E32ds_v4 because both of those VM types use Ultra SSDs. ##Similarly, when you deploy a new Cloud Volumes ONTAP system, you can't change the VM type to one that _doesn't_ support Premium SSD v2 Managed Disks##.
+
...
a| Supported disk types 5+| Standard HDD Managed Disks, Standard SSD Managed Disks, Premium SSD Managed Disks, and ##Premium SSD v2 Managed Disks##.
