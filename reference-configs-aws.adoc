...
(disks + object storage) | 2 TiB | 10 TiB | 368 TiB
...
| Supported disk types 3+a|
* General Purpose SSD (gp3 and gp2)
* Provisioned IOPS SSD (io1)
* Throughput Optimized HDD (st1)

| Cold data tiering to S3 | Not supported 2+| Supported
|===
...
The following additional notes provide general guidance about supported instance behavior and deployment options.
