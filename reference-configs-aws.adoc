...
. AWS Local Zones only support the General Purpose SSD (gp2) disk type.
...
| m5.xlarge ^7^ | 4 | 16 | Not supported | Up to 10 | Up to 4,750 | Supported (single node only)

.3+| *Standard or any other license*

| r5.xlarge ^7^ | 4 | 32 | Not supported | Up to 10 | Up to 4,750 | Supported (single node only)

| m5a.2xlarge | 8 | 32 | Not supported | Up to 10 | Up to 2,880 | Supported

| m5.2xlarge ^7^ | 8 | 32 | Not supported | Up to 10 | Up to 4,750 | Supported

.22+| *Premium or any other license*

| m5n.2xlarge | 8 | 32 | Not supported | Up to 25 | Up to 4,750 | Supported

| r5.2xlarge ^7^ | 8 | 64 | Not supported | Up to 10 | Up to 4,750 | Supported

| r5d.2xlarge | 8 | 64 | Supported | Up to 10 | Up to 4,750 | Supported

| c5d.4xlarge ^7^ | 16 | 32 | Supported | Up to 10 | 4,570 | Supported

| m5.4xlarge ^7^ | 16 | 64 | Not supported | Up to 10 | 4,750 | Supported
...
. AWS Local Zones are supported in the following EC2 instance type families with sizes xlarge to 4xlarge: M5, C5, C5d, R5, and R5d. 
