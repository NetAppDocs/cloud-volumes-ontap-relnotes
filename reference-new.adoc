...
The Cloud Volumes ONTAP 9.16.1 General Availability release is now available for deployment in only Azure and Google Cloud. However, this version is available for upgrade in all cloud providers, AWS, Azure, and Google Cloud.
...
You can upgrade to Cloud Volumes ONTAP 9.16.1 from the 9.15.1 release. BlueXP will prompt you to upgrade the eligible Cloud Volumes ONTAP systems to this release.
