...
You can now segregate SnapMirror replication traffic from data and management traffic. This new feature allows you to leverage an additional subnet that isn't routable to the existing subnet used for data and management traffic. 
