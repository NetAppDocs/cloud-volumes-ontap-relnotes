...
keywords: what's new, new, features, release notes, enhancements, NetApp Console, the Console,
...
Additional features and enhancements are also introduced in the latest versions of the NetApp Console. See the https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/whats-new.html[NetApp Console Release Notes^] for details.

== 9.16.1 P5 (28 July 2025)
The 9.16.1 P5 patch can now be deployed and upgraded for Cloud Volumes ONTAP in Azure and Google Cloud. However, this version is unavailable for deployment and upgrade in AWS. The Console will prompt you to upgrade your existing systems to this patch release.
...
The 9.16.1 P4 patch can now be deployed and upgraded for Cloud Volumes ONTAP in Azure and Google Cloud. However, this version is unavailable for deployment and upgrade in AWS. The Console will prompt you to upgrade your existing systems to this patch release.
...
The 9.16.1 P3 patch can now be deployed and upgraded for Cloud Volumes ONTAP in Azure and Google Cloud. However, this version is unavailable for deployment and upgrade in AWS. The Console will prompt you to upgrade your existing systems to this patch release.
...
The 9.16.1 P2 patch can now be deployed and upgraded for Cloud Volumes ONTAP in Azure and Google Cloud. However, this version is unavailable for deployment and upgrade in AWS. The Console will prompt you to upgrade your existing systems to this patch release.
...
The 9.16.1 P1 patch can now be deployed and upgraded for Cloud Volumes ONTAP in Azure and Google Cloud. However, this version is unavailable for deployment and upgrade in AWS. The Console will prompt you to upgrade your existing systems to this patch release.
...
You can upgrade to Cloud Volumes ONTAP 9.16.1 GA from the 9.15.1 release in Azure and Google Cloud. The Console will prompt you to upgrade eligible Cloud Volumes ONTAP systems to this release.
