...
This deployment mode, by default, makes use of Premium SSD v2 Managed Disks. It covers all flavors of the HA mode, Pageblob, locally-redundant storage (LRS), zone-redundant storage (ZRS) or multi-zonal, and LRS zonal (single AZ).
