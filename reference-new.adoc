...
CVO 9.15.1 in Azure leverages Virtual Machines Scale Sets in Flexible orchestration mode for deploying virtual machine (VM) instances in a single availability zone. This deployment mode, by default, makes use of Premium SSD v2 Managed Disks.
