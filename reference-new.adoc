...
Additional features and enhancements are also introduced in the latest versions of NetApp Console. See the https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/whats-new.html[NetApp Console Release Notes^] for details.
