...
== 9.14.1 (19 December 2023)
The Release Candidate 1 (RC1) release of Cloud Volumes ONTAP 9.14.1 is now available in AWS, Azure, and Google Cloud. 
...
You can upgrade to Cloud Volumes ONTAP 9.14.1 from the 9.14.0 release. BlueXP will prompt you to upgrade eligible Cloud Volumes ONTAP systems to this release.
