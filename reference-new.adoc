...
The Cloud Volumes ONTAP 9.16.1 GA is now available for deployment in only Azure and Google Cloud. This version is available for upgrade in AWS, Azure, and Google Cloud.
...
You can upgrade to Cloud Volumes ONTAP 9.16.1 from the 9.15.1 release in AWS, Azure and Google Cloud. BlueXP will prompt you to upgrade eligible Cloud Volumes ONTAP systems to this release.
