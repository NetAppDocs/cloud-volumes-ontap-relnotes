...
== 9.16.1 (9 December 2024)
The Cloud Volumes ONTAP 9.16.1 is now available in AWS, Azure, and Google Cloud. The GA version is available for deployment and upgrade. 
