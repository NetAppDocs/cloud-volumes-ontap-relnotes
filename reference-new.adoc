...
== 9.16.1 RC1 (9 December 2024)
The Cloud Volumes ONTAP 9.16.1 is now available in AWS, Azure, and Google Cloud. The RC1 version is available for deployment and upgrade. 
