...
== Software updates must be completed by the Console
...
Changes to a Cloud Volumes ONTAP configuration from your cloud provider's console results in an unsupported configuration. Any changes to the Cloud Volumes ONTAP resources that the Console creates and manages can impact system stability and the Console's ability to manage the system.
