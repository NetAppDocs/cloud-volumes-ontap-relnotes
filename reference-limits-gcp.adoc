...
* BlueXP starting from Cloud Volumes ONTAP 9.13.1 size of 300 TiB for a FlexVol volume is supported starting from Cloud Volumes ONTAP 9.12.1 P2 and 9.13.0 P2.
