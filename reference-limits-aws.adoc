...
NetApp doesn't support exceeding the system capacity limit. If you reach the licensed capacity limit, the Console displays an action required message and no longer allows you to add additional disks.
